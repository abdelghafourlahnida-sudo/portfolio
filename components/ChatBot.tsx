...
const WELCOME: Message = {
  role: 'assistant',
  content:
    "Hi! I'm **Abdelghafour AI** 👋. I can tell you about Abdelghafour's experience, projects, technical skills, education, and how to get in touch.",
}
    ...
    <>
      ...
      <AnimatePresence>
        {!open && (
           ...
           >
             <span className="text-sm font-medium text-white">Chat with <span className="text-mint font-semibold">Abdelghafour AI</span></span>
        ...
        {open && (
          ...
          >
            ...
            >
              ...
              <div>
                <p className="text-text font-semibold text-sm leading-tight">Abdelghafour AI</p>
            ...
            >
              <input
                ...
                placeholder="Ask me anything about Abdelghafour..."
                disabled={streaming}

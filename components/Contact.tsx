    ...
    <section id="contact" className="py-section px-6" ref={ref}>
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="mb-14"
        >
          <span className="label-chip mb-4 inline-flex"><MessageSquare size={12} /> Let&apos;s{' '} Connect</span>
        ...
        <div className="grid md:grid-cols-5 gap-10">
          ...
          >
            {[
              ...
              { icon: <MapPin size={18} className="text-mint" />, label: 'Location', value: 'Marrakech, Morocco • Remote Worldwide', href: null },
            ].map((item) => (

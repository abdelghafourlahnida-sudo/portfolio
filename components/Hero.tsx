    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          >
            I&apos;m <span className="text-text font-semibold">Abdelghafour Lahnida</span>, a full-stack developer
            focused on building scalable systems, intuitive user experiences,
            and reliable applications used in real-world environments.
          </motion.p>
          ...
          >
            I work across backend logic, frontend interfaces, and mobile experiences —
            solving real problems with clean, efficient solutions.
          </motion.p>
          ...
          >
            ...
            <a
              href="/abdelghafour-resume.pdf"
              download="Abdelghafour_Resume.pdf"
              target="_blank"
          ...
          {/* Social */}
          <motion.div
            variants={FADE} initial="hidden" animate="visible" custom={5}
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="ml-4 text-muted text-xs">abdelghafour@portfolio ~</span>
            </div>

            {/* whoami */}
            <p className="text-muted">
              $ <span className="text-mint">whoami</span>
            </p>
            <p className="text-text mt-1">
              <TypingLine text="Abdelghafour Lahnida — Full-Stack Developer" delay={300} />
            </p>

            {/* skills */}
            <p className="text-muted mt-3">
              $ <span className="text-mint">cat skills.json</span>
            </p>

            <pre className="mt-1 text-xs leading-6 text-text/80 whitespace-pre-wrap">
             <TypingLine
  delay={800}
  speed={5}
  text={`{
  "frontend": ["HTML", "CSS", "JavaScript", "React", "Angular", "Ember", "Tailwind", "Bootstrap"],
  "mobile": ["React Native"],
  "backend": ["PHP", "Node.js", "Laravel", "REST APIs"],
  "databases": ["MySQL", "MongoDB"],
  "tools": ["Docker", "Git", "Linux"],
  "other": ["WordPress", "Accessibility", "Agile / Scrum"]
}`}
/>
            </pre>
            ...
            {/* status */}
            <p className="text-muted mt-3">
              $ <span className="text-mint">git status</span>
            </p>
            <p className="text-green-400 mt-1 text-xs">
              <TypingLine
                delay={2600}
                text="✓ Ready to build and ship production systems"
              />
            </p>

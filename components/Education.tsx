...
import { GraduationCap, BookOpen, Award, Check } from 'lucide-react'
...
const educationData: EducationItem[] = [
  {
    ...
    branch: 'Digital Development — Full Stack',
    institution: 'ISTA NTIC',
    affiliation: 'Sidi Youssef Ben Ali — Marrakech',
    yearRange: '2021 — 2023',
    score: 'Full Stack Specialization',
    scoreType: 'cgpa',
    achievements: [
...

  {
    ...
    institution: 'Ibnou Almouataz High School',
    affiliation: 'Marrakech, Morocco',
    yearRange: '2018 — 2019',
    score: 'Physical Sciences',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted text-lg max-w-lg mx-auto mt-3">
            The educational foundation and technical journey behind my development career.
          </p>
        </motion.div>

...
const RESUME_URL = '/abdelghafour-resume.pdf'
    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          >
            <span className="text-mint transition-all duration-200 group-hover:drop-shadow-[0_0_8px_rgba(93,202,165,0.8)]">A</span>
            <span className="text-text">bdelghafouur</span>

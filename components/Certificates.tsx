...
import { BookOpen, Code2, Trophy, Star, ExternalLink } from 'lucide-react'

// ── Types ─────────────────────────────────────────────────────────────────────
type Category = 'all' | 'courses' | 'coding'
...
const certificatesData: Certificate[] = [
{
  ...
  category: 'courses',
  description:
    'Advanced frontend development concepts including responsive interfaces, component architecture, accessibility, and modern UI practices.',
  featured: true,
},

{
  ...
  category: 'coding',
  description:
    'Focused on responsive layouts, accessibility standards, semantic HTML, and modern CSS techniques.',
},

{
  ...
  category: 'coding',
  description:
    'Deepened knowledge in frontend architecture, performance optimization, and scalable component systems.',
},

{
  id: 4,
  title: 'REST API Development',
  platform: 'Professional Learning',
  date: '2024',
  category: 'courses',
  description:
    'Covered API architecture, authentication flows, backend integration, and scalable service communication.',
},

{
  ...
  category: 'coding',
  description:
    'Covered core JavaScript concepts, problem-solving patterns, algorithms, data structures, and application logic used in modern web development.',
},

{
  ...
  category: 'courses',
  description:
    'Learned containerization workflows, environment management, deployment basics, and scalable development practices using Docker.',
},
]
...
const STATS = [
  ...
  { number: 100, label: 'Production Fixes' },
]

// ── Filter config ─────────────────────────────────────────────────────────────
const FILTERS: { label: string; value: Category }[] = [
  { label: 'All', value: 'all' },
  { label: 'Development', value: 'coding' },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-muted max-w-2xl text-lg leading-relaxed">
            A combination of technical learning, real-world experience, and continuous growth across modern development technologies.
          </p>
        </motion.div>

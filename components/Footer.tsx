...
const NAV_LINKS = [
  ...
  { label: 'Growth',       href: '#certificates' },
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid sm:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            <p className="font-heading font-bold text-xl mb-2">
              <span className="text-mint">A</span>bdelghafouur<span className="text-mint">.</span>
            </p>
            <p className="text-muted text-sm leading-relaxed">
              Full-Stack Developer building scalable web applications, APIs, and digital solutions with a focus on performance and user experience.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-muted text-xs flex items-center gap-1.5">
            Designed & developed by  <Heart size={12} className="text-mint fill-mint" /> 
            Abdelghafour Lahnida
